...
export default async function ConfiguracoesPage() {
  ...
  const [ticker, classificacoes, usuarios, causasMorte] = await Promise.all([
  ...
  return <ConfiguracoesClient ticker={tickerMap} classificacoes={classificacoes} usuarios={usuarios} causasMorte={causasMorte} />;
}

...
// GET  → preview spreadsheet (returns first 10 rows + total)
// POST → confirm import: create lot + add animals + optionally update peso
...
export async function POST(req: NextRequest) {
  ...
  // Block animals already in active lot
  ...
  // Build item data map (id → { pesoAtual, valorUnit })
  ...
  // Optionally update animal.peso with pesoAtual
  if (atualizarPeso) {
